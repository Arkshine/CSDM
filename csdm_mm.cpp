...
{
	print_srvconsole("[CSDM] Version %s (C)2003-2007 David \"BAILOPAN\" Anderson\n", MODULE_VERSION);
	print_srvconsole("[CSDM] Written by the CSDM Team (BAILOPAN and Freecode)\n");
...
void ClientCommand(edict_t *pEntity)
{
	...
	{
		print_client(pEntity, 2, "[CSDM] Version %s (C)2003-2007 David \"BAILOPAN\" Anderson\n", MODULE_VERSION);
		print_client(pEntity, 2, "[CSDM] Written by the CSDM Team (BAILOPAN and Freecode)\n");
